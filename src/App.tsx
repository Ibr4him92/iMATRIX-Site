...
import { AiFillCloseCircle, AiOutlineDoubleRight } from "react-icons/ai";
import {
  BsWhatsapp,
  BsFacebook,
  BsTwitter,
      ...
      <>
          ...
          <div className="container">
            <div className="col">
              ...
              <p data-aos="fade-out">
                ...
                take education from the platform, and start trading with a
                capital other than the one he paid for the course.
              </p>
              <p data-aos="fade-out">
                The IMATRIX company has the advantage of providing a creative
                teaching service, offering free education, then training on a
                mock account for a duo not less than two weeks and not more than
                a month, and then starting a money market trip, through which
                you will pay the company through your circulation and your work
          ...
          <div className="container">
            <div className="col">
              ...
              <div className="item-two">
                ...
                <p data-aos="fade-out">
                  [1] The education is completed within the two-week period
                  agreed between team one and team two.
                </p>
                <p data-aos="fade-out">
        ...
        <div className="videos" id="videos">
          <div className="main-heading">
            ...
            <p data-aos="fade-out">
              If a trader is motivated by the money, then it is the wrong
              reason. A truly successful trader has got to be involved and into
              the trading, the money is the side issue .
            </p>
          </div>
          <div className="container">
        ...
        <footer>
          <div className="container">
            <div className="box">
              ...
              <p data-aos="fade-out">
                It's not whether you're right or wrong that's important, it's
